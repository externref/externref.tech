...
<div class="pb-44 lg:pb-0">
	...
	<div class="block lg:flex lg:flex-row mx-auto max-w-screen-xl">
		<div class=" px-4 w-full max-w-2xl h-full md:h-auto">
			<!-- Modal content -->
		...
		<div class="px-4 mx-auto max-w-screen-xl py-10 lg:py-2 lg:px-6">
			<div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
				...
				<div
					class="my-5 lg:my-0 text-center ml-5 text-[#c5c6c7] text-xl font-exo2 grid grid-rows-4 grid-cols-2 gap-x-4 gap-y-4 lg:float-left"
				>
